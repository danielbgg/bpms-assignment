...
public class EletricalPermitService {
	...
	public int request(PermitRequest request) {
		System.out
				.println("[REST Eletrical Permit] Requesting Eletrical Permit for: "
						+ request);
	...
	public PermitResponse query(@PathParam("id") int id) {
		...
		System.out.println("[REST Eletrical Permit] Query for: " + resp);
		return resp;
	}
	...
	public boolean cancel(@PathParam("id") int id) {
		...
		System.out.println("[REST Eletrical Permit] Cancel for id: " + id
				+ " - result: " + b);
		return b;
	}
